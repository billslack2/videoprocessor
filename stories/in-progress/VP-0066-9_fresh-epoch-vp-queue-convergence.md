...
2. **Timestamp ownership/rebase (next):** move final presentation/media-time
   assignment to the delivery boundary, or provide an equivalently testable
   queue-rebase transaction. Replayed normal delivery must retain legacy
   60000/1001 and 24000/1001 timing; a startup convergence must skip picture
   content without non-increasing or gapped sample time.
