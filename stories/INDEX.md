...
- Last assigned item: `VP-0057`
- Next story number: `VP-0058`
...
| VP-0041 | In Progress | Eliminate stale-frame flashes across renderer rebuilds (madVR-only repro; graph-reset gap and crash under investigation) |
