...
- Last assigned item: `VP-0055`
- Next story number: `VP-0056`
- Total indexed items: 55
...
| VP-0041 | In Progress | Eliminate stale-frame flashes across renderer rebuilds (reopened: issue remains reproducible) |
...
| VP-0054 | In progress | DirectShow handoff queue saturation and UI-liveness recovery |
| VP-0055 | Review | Display-rate outlier quarantine and transition warm-up |
